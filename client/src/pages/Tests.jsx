    ...
    <div className="flex bg-slate-900 min-h-screen text-white">
      ...
      <div className="flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700 hover:border-yellow-400 transition">
          ...
          <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700 hover:border-red-400 transition">
